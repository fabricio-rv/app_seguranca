...
class _NovoChamadoTecnicoPageState extends State<NovoChamadoTecnicoPage>
  ...
  static const int minLength =
      5; // Aumentei um pouco para garantir descrições úteis
  ...
  void _enviar() {
    if (!_formValido) {
      _mostrarModalFeedback(
        ...
        mensagem:
            'Por favor, selecione qual equipamento está com problema e descreva a situação para o técnico.',
      );
      return;
    }
    ...
    _mostrarModalFeedback(
      ...
      mensagem:
          'Sua solicitação foi registrada. Um técnico da Protepac analisará o caso e entrará em contato em breve.',
      onConfirmar: () {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Precisando de manutenção ou revisão?\nInforme os detalhes abaixo.',
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            color: cinzaTexto,
                            fontSize: 15,
                        ...
                        _buildPremiumTextField(
                          ...
                          hint: 'Ex: A câmera frontal parou de gravar...',
                          azul: azul,
                          laranja: laranja,
                          minLines: 5,
                          showCounter: true,
